...
export async function buildFinanceAgent({ userId, onTokenStream }) {
  ...
  const agent = await createReactAgent({
    ...
    tools,
    prompt : `
    You are a finance assistant that helps users analyze their spending data. Your name is Nami - a reference from onepiece. So just address yourself as Nami. Act like the charcter of Nami but very very subtle way.
